...
def xlerobot_cameras_config() -> dict[str, CameraConfig]:
    return { 
        "left_wrist": OpenCVCameraConfig(
            index_or_path=6, fps=30, width=640, height=480, rotation=Cv2Rotation.NO_ROTATION,fourcc="MJPG"
        ),

        "right_wrist": OpenCVCameraConfig(
            index_or_path=4, fps=30, width=640, height=480, rotation=Cv2Rotation.NO_ROTATION,fourcc="MJPG"
        ),  

        "head(RGDB)": OpenCVCameraConfig(
            index_or_path=2, fps=30, width=640, height=480, rotation=Cv2Rotation.NO_ROTATION,fourcc="MJPG"
        ),
